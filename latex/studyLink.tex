...
\begin{tabularx}{\textwidth}{|p{2cm}|X|p{3cm}|}
    ...
    \reqlabel{R15F}R15F & Se un Utente annulla la sua Prenotazione per 3 volte entro 30 giorni, gli viene sospesa la possibilità di iscriversi o creare altri Eventi per 7 giorni & Funzionale \\ \hline
    \reqlabel{R16F}R16F & L'Organizzatore può modificare i dettagli dell'Evento o cancellarlo fino all'ora precedente & Funzionale \\ \hline
    \reqlabel{R17F}R17F & Ogni modifica di un Evento invia una Notifica a tutti i Partecipanti & Funzionale \\ \hline
    \reqlabel{R18F}R18F & L'Organizzatore può rimuovere i Partecipanti all'Evento a sua discrezione & Funzionale \\ \hline
    \reqlabel{R19F}R19F & Per ogni Evento è prevista una Chat di gruppo accessibile solo ai Partecipanti & Funzionale \\ \hline
    \reqlabel{R20F}R20F & Al termine dell'Evento, ciascun Partecipante può lasciare un Commento a ognuno degli altri presenti & Funzionale \\ \hline
    \reqlabel{R21F}R21F & Un Utente può richiedere l'eliminazione del proprio Profilo & Funzionale \\ \hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|X|X|X|X|}
    ...
    \endhead
    Furto Credenziali Utente & \textbf{Media.} La Mail istituzionale è nota, le passoword devono essere indovinate & Imposizione di requisiti di sicurezza sulle Password limitazioni di tentativi di accesso
...
\begin{tabularx}{\textwidth}{|X|X|X|X|}
    ...
    \endhead
    Nome & semplice & Protezione media & Non più di 40 caratteri \\ \hline
    Cognome & semplice & Protezione media & Non più di 40 caratteri \\ \hline
    Corso di studi & semplice & Protezione media & Non più di 50 caratteri \\ \hline
    Biografia & semplice & Protezione media & Non più di 250 caratteri \\ \hline
    Immagine & semplice & Protezione media & Percorso file valido, non più di x Mb \\ \hline
...
\begin{tabularx}{\textwidth}{|X|X|X|X|}
    ...
    Materia & semplice & Protezione media & Non più di 100 caratteri \\ \hline
    ...
    Numero posti & semplice & Protezione media & Non più di 100 persone \\ \hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|X|X|X|X|}
    ...
    \rowcolor{studyColor} \textbf{Informazione} & \textbf{Tipo} & \textbf{Livello protezione / Privacy} & \textbf{Vincoli} \\ \hline
    \endhead
    Via & semplice & Protezione alta & Non più di 100 caratteri \\ \hline
    Nome struttura o aula & semplice & Protezione alta & Non più di 100 caratteri \\ \hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|X|X|X|X|}
    ...
    Data prenotazione & semplice & Protezione media & Nel formato GG/MM/AAAA HH:MM \\ \hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|X|X|X|X|}
    ...
    \rowcolor{studyColor} \textbf{Informazione} & \textbf{Tipo} & \textbf{Livello protezione / Privacy} & \textbf{Vincoli} \\ \hline
    \endhead
    Profilo & composto & Protezione media & \\ \hline
    Profilo & composto & Protezione media & \\ \hline
    Testo & semplice & Protezione media & Massimo 500 caratteri \\ \hline
    Valutazione & semplice & Protezione media & Valore numerico indicante valutazione positiva o negativa \\ \hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|X|X|X|X|}
    ...
    \endhead
    Profilo & composto & Protezione alta & \\ \hline
    Testo & semplice & Protezione alta & Massimo 1000 caratteri \\ \hline
    Data e ora & semplice & Protezione alta & Nel formato GG/MM/AAAA HH:MM \\ \hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|X|X|X|X|}
    ...
    \rowcolor{studyColor} \textbf{Informazione} & \textbf{Tipo} & \textbf{Livello protezione / Privacy} & \textbf{Vincoli} \\ \hline
    \endhead
    Avviso & composto & Protezione alta & \\ \hline
    Data e ora & semplice & Protezione alta & Nel formato GG/MM/AAAA HH:MM \\ \hline
\end{tabularx}

\subsubsection{Informazione: Avviso} \label{Avviso}
L'informazione \hyperref[Avviso]{Avviso} è composta da:
\begin{tabularx}{\textwidth}{|X|X|X|X|}
    \hline
    \rowcolor{studyColor} \textbf{Informazione} & \textbf{Tipo} & \textbf{Livello protezione / Privacy} & \textbf{Vincoli} \\ \hline
    \endhead
    Testo & semplice & Protezione alta & Massimo 255 caratteri \\ \hline
    Tipo & semplice & Protezione alta & Identificativo della tipologia di avviso \\ \hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|X|X|X|X|}
    ...
    \rowcolor{studyColor} \textbf{Informazione} & \textbf{Tipo} & \textbf{Livello protezione / Privacy} & \textbf{Vincoli} \\ \hline
    \endhead
    Data & semplice & Protezione alta & Nel formato GG/MM/AAAA \\ \hline
    Ora & semplice & Protezione alta & Nel formato HH:MM \\ \hline
    Profilo & composto & Protezione alta & \\ \hline
    Azione & semplice & Protezione alta & Descrizione dell'operazione effettuata \\ \hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|X|X|X|X|X|}
    ...
    \endhead
    Email & semplice & Protezione alta & Input & Email istituzionale universitaria (es. @studio.unibo.it) \\ \hline
    Password & semplice & Protezione alta & Input & Almeno 8 caratteri, contenente un numero e un carattere speciale (R08N) \\ \hline
...
\begin{tabularx}{\textwidth}{|X|X|X|X|X|}
    ...
    \rowcolor{studyColor} \textbf{Informazione} & \textbf{Tipo} & \textbf{Livello protezione / Privacy} & \textbf{Input / Output} & \textbf{Vincoli} \\ \hline
    \endhead
    Email & semplice & Protezione alta & Input & Email utilizzata in fase di registrazione \\ \hline
    Password & semplice & Protezione alta & Input & Password associata all'account \\ \hline
    Profilo & composto & Protezione media & Output & \\ \hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|X|X|X|X|X|}
    ...
    Valutazione & semplice & Protezione media & Input & Valore numerico indicante valutazione positiva o negativa \\ \hline
    Commento & composto & Protezione media & Output & \\ \hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|X|X|X|X|X|}
    ...
    \rowcolor{studyColor} \textbf{Informazione} & \textbf{Tipo} & \textbf{Livello protezione / Privacy} & \textbf{Input / Output} & \textbf{Vincoli} \\ \hline
    \endhead
    Data & semplice & Protezione media & Input & Non più di 40 caratteri \\ \hline
    Ora & semplice & Protezione media & Input & Non più di 40 caratteri \\ \hline
    Operazione eseguita & composto & Protezione alta & Input & \\ \hline
    Messaggio & composto & Protezione molto alta & Input & \\ \hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|X|X|X|X|}
    \hline
    \rowcolor{studyColor} \textbf{Requisito} & \textbf{Categorie} & \textbf{Impatto} & \textbf{Funzionalità} \\ \hline
    \endhead
    Accessibilità online (R01N) & Disponibilità & Garantire continuità del servizio & Tutte \\ \hline
    Univocità credenziali (R02N) & Sicurezza & Migliora l'integrità dei dati & Registrazione, Autenticazione \\ \hline
    Interfaccia intuitiva (R03N) & Usabilità & Cercare di migliorare & Visualizzazione Bacheca, Tutte \\ \hline
    Fuso orario GMT+1 (R04N) & Usabilità & Standardizzazione e chiarezza & Creazione Evento, Gestione Evento, Tutte \\ \hline
    Formato data e ora (R05N) & Usabilità & Standardizzazione e chiarezza & Creazione Evento, Gestione Evento, Tutte \\ \hline
    Rispetto GDPR (R06N) & Sicurezza & Migliorano la privacy dei dati & Gestione Profilo, Tutte \\ \hline
    Bacheca aggiornata (R07N) & Tempo di risposta & Cercare di migliorare & Visualizzazione Bacheca \\ \hline
    Password sicura (R08N) & Sicurezza & Peggiorano usabilità, migliorano la privacy dei dati & Registrazione, Autenticazione, Gestione Profilo \\ \hline
    Messaggi istantanei (R09N) & Tempo di risposta & Cercare di migliorare & Utilizzo Chat \\ \hline
    Cifratura HTTPS/TLS (R10N) & Sicurezza & Peggiorano tempo di risposta, migliorano la privacy dei dati & Tutte \\ \hline
    Blocco account (R11N) & Sicurezza & Peggiorano tempo di risposta e usabilità, migliorano la privacy dei dati & Autenticazione \\ \hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|p{4.5cm}|X|p{4cm}|}
    ...
    View Gestione Evento & Dati Evento precompilati, Elenco Partecipanti (con opzione di rimozione) & Gestione evento, Rimozione partecipante, Cancellazione evento \\ \hline
    ...
    Home Log & Scelta del tipo di analisi o visione del registro delle operazioni & AnalisiLog (sistema esterno) \\ \hline
\end{tabularx}
...
\subsection{Modello del dominio: Utente e Profilo}

\subsection{Modello del dominio: Evento}

\subsection{Modello del dominio: Prenotazione}

\subsection{Modello del dominio: Bacheca e Filtro}

\subsection{Modello del dominio: Chat e Messaggio}

\subsection{Modello del dominio: Commento}

\subsection{Modello del dominio: Log di sistema}
