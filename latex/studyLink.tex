...
Il modello riguardante la prenotazione è presentato nel seguente diagramma.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{images/modello-del-dominio-prenotazione.png}
\end{figure}

\subsection{Modello del dominio: Bacheca}
Il modello riguardante la bacheca è presentato nel seguente diagramma.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{images/modello-del-dominio-bacheca.png}
\end{figure}
...
\section{TODO}
\begin{itemize}[leftmargin=*]
    togliere subsubsection dall'indice \item 
\end{itemize}
