...
\begin{tabularx}{\textwidth}{|p{2cm}|X|p{3cm}|}
    ...
    \reqlabel{R03N}R03N & L'Username deve essere univoco & Non funzionale \\ \hline
    \reqlabel{R04N}R04N & L'interfaccia della Bacheca deve essere essenziale ed intuitiva & Non funzionale \\ \hline
    \reqlabel{R05N}R05N & Il fuso orario usato dall'applicazione è GMT+1 & Non funzionale \\ \hline
    \reqlabel{R06N}R06N & Il formato di data e orario è gg/mm/aa e hh:mm 24h & Non funzionale \\ \hline
    \reqlabel{R07N}R07N & L'applicazione deve rispettare le norme definite nel \href{https://gdpr-info.eu/}{GDPR} & Non funzionale \\ \hline
    \reqlabel{R08N}R08N & La Bacheca globale deve essere costantemente aggiornata & Non funzionale \\ \hline
    \reqlabel{R09N}R09N & La Password scelta dall'Utente deve essere di almeno 8 caratteri e contenere almeno un numero e un carattere speciale (\#@?!\_-) & Non funzionale \\ \hline
    \reqlabel{R10N}R10N & La ricezione ed invio dei Messaggi deve essere istantanea & Non funzionale \\ \hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|X|X|}
    ...
    \textbf{Relazioni} & Da aggiungere \\ \hline
...
\begin{tabularx}{\textwidth}{|X|X|}
    ...
    \textbf{Scenari alternativi} & 
        \begin{itemize}[nosep, leftmargin=*, before=\vspace{-0.5\baselineskip}, after=\vspace{-0.8\baselineskip}]
            \item La Email è già presente
            \begin{enumerate}[nosep, leftmargin=*]
                \setcounter{enumi}{2}
                \item Viene mostrato un messaggio di errore
                \item L'Utente può inserire una nuova Email
            \end{enumerate}
            \item La Email non è istituzionale
            \begin{enumerate}[nosep, leftmargin=*]
                \setcounter{enumi}{2}
...
\newpage
\subsubsection{Creazione di un Evento}
\reqlabel{tab:Creazione di un Evento}
\begin{tabularx}{\textwidth}{|X|X|}
    \hline
    \textbf{Titolo} & \textbf{Creazione di un Evento} \\ \hline
    \endhead
    ...
    \textbf{Relazioni} &
        ...
        \end{itemize} \\ \hline
    \textbf{Precondizioni} & \\ \hline
    \textbf{Postcondizioni} & Il sistema memorizza le modifiche effettuate \\ \hline
    \textbf{Scenario principale} &
        \begin{enumerate}[nosep, leftmargin=*, before=\vspace{-0.5\baselineskip}, after=\vspace{-0.8\baselineskip}]
            \item \hyperref[tab:Autenticazione]{Autenticazione}
    ...
    \textbf{Scenari alternativi} & 
        \begin{itemize}[nosep, leftmargin=*, before=\vspace{-0.5\baselineskip}, after=\vspace{-0.8\baselineskip}]
            ...
            \end{enumerate}
            \item Il numero di posti inserito è pari a 0 (potremmo fare che 0 equivale a dire che è libero ma secondo me non è molto intuitivo)
            \begin{enumerate}[nosep, leftmargin=*]
                \setcounter{enumi}{4}
                \item Viene mostrato un messaggio di errore
                \item L'Utente può inserire un numero di partecipanti valido
            \end{enumerate}
            \item La Posizione o il Luogo non sono validi o non esistenti
            \begin{enumerate}[nosep, leftmargin=*]
                \setcounter{enumi}{4}
                \item Viene mostrato un messaggio di errore
                \item L'Utente può inserire una nuova posizione
            \end{enumerate}
        \end{itemize} \\ \hline
...
\reqlabel{tab:TEMPLATE}
\begin{tabularx}{\textwidth}{|X|X|}
    \hline
    \textbf{Titolo} & \textbf{TEMPLATE} \\ \hline
    \endhead
    \textbf{Descrizione} & DESCRIZIONE \\ \hline
    \textbf{Attori} & ATTORE \\ \hline
    \textbf{Relazioni} & RELAZIONE
        \begin{itemize}[nosep, leftmargin=*, before=\vspace{-0.5\baselineskip}, after=\vspace{-0.8\baselineskip}]
            \item % \hyperref[tab:etichetta]{testo visibile}
        \end{itemize} \\ \hline
...
\begin{tabularx}{\textwidth}{|X|X|}
    ...
    \endhead
    Tecnologia & \begin{itemize}[nosep, leftmargin=*, before=\vspace{-0.5\baselineskip}, after=\vspace{-0.8\baselineskip}]
                    \item Punto 1;
                    \item Punto 2
                \end{itemize} \\ \hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|X|X|}
    ...
    \textbf{Requisiti non funzionali} & \hyperref[R01N]{R01N} \\ \hline
...
\begin{itemize}[leftmargin=*]
    ...
    \item R03N parla ancora di Username
    \item R02N parla di Credenziali univoche, ma le Credenziali sono una coppia di Email e Password
\end{itemize}
