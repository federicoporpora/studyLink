...
\begin{tabularx}{\textwidth}{|p{2cm}|X|p{3cm}|}
    ...
    R06F & Le caratteristiche di un Evento sono: titolo, Tipo di Luogo, data, orario, Indirizzo, posti disponibili & Funzionale \\ \hline
    ...
    R12F & Gli Utenti possono filtrare gli Eventi dalla Bacheca per: Tipo di Luogo, Indirizzo, data, numero posti & Funzionale \\ \hline
    ...
    R23F & Un Utente può richiedere l'eliminazione del proprio Profilo & Funzionale \\ \hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|X|X|}
    ...
    \endhead
    \textbf{Descrizione} & Permette all'Organizzatore di visualizzare i commenti dei Partecipanti sull'Evento \\ \hline
    \textbf{Attori} & Organizzatore \\ \hline
    \textbf{Relazioni} & 
        \begin{itemize}[nosep, leftmargin=*]
