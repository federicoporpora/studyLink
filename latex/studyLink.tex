...
\begin{tabularx}{\textwidth}{|X|X|}
    \hline
    \textbf{Titolo} & \reqlabel{tab:Registrazione}\textbf{Registrazione} \\ \hline
    \endhead
...
\begin{tabularx}{\textwidth}{|X|X|}
    \hline
    \textbf{Titolo} & \reqlabel{tab:Autenticazione}\textbf{Autenticazione} \\ \hline
    \endhead
...
\begin{tabularx}{\textwidth}{|X|X|}
    \hline
    \textbf{Titolo} & \reqlabel{tab:GestioneProfilo}\textbf{Gestione profilo} \\ \hline
    \endhead
...
\begin{tabularx}{\textwidth}{|X|X|}
    \hline
    \textbf{Titolo} & \reqlabel{tab:TEMPLATE}\textbf{TEMPLATE} \\ \hline
    \endhead
