...
\textcolor{red}{fede metti a posto te i problemi di impaginazione con il tuo gemini linuxiano che il mio è ritardato non ce la fa; 
                non so se vanno messi anche i non funzionali in questa tabella;
                mancano cose dei Log, guarda doVado}
\vspace{1cm}
\begin{tabularx}{\textwidth}{|X|X|X|X|}
    \hline
