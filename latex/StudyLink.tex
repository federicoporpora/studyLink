...
\begin{tabularx}{\textwidth}{|p{3.2cm}|X|p{2.3cm}|p{2.8cm}|}
    ...
    Invio notifica & \begin{itemize}[nosep, leftmargin=*, before={\vspace{-0.5\baselineskip}}, after={\vspace{-0.8\baselineskip}}]
                        \item Interazione esterno;
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.5\textheight,keepaspectratio]{images/diagramma-di-dettaglio-log.png}
\end{figure}
%
In questo diagramma è da notare che:
\begin{itemize}[leftmargin=*]
...
%    \hspace{0.05\textwidth}
%    \includegraphics[width=0.35\textwidth]{images/interfaccia-crea-evento.png}
...
%\begin{figure}[H]
%    \centering
%    \includegraphics[width=0.35\textwidth]{images/interfaccia-bacheca-esplora.png}
%    \hspace{0.05\textwidth}
%    \includegraphics[width=0.35\textwidth]{images/interfaccia-bacheca-miei-eventi.png}
%    \hspace{0.05\textwidth}
%    \includegraphics[width=0.35\textwidth]{images/interfaccia-bacheca-passati.png}
%    \caption{Bacheca: Esplora (sinistra), I miei eventi (centro), Passati (destra)}
%\end{figure}
%
%\begin{figure}[H]
%    \centering
%    \includegraphics[width=0.35\textwidth]{images/interfaccia-dettagli-evento.png}
%    \hspace{0.05\textwidth}
%    \includegraphics[width=0.35\textwidth]{images/interfaccia-dettagli-utente.png}
%    \hspace{0.05\textwidth}
%    \includegraphics[width=0.35\textwidth]{images/interfaccia-chat.png}
%    \caption{Bacheca: Dettagli Evento (sinistra), Dettagli Utente (centro), Chat (destra)}
%\end{figure}
%
...
\begin{itemize}[leftmargin=*]
    \item Il deploy del \textbf{backend} verrà effettuato inizialmente su un singolo nodo, ma sarà eseguito con strumenti di automazione come Docker (come configurato nell'ambiente di sviluppo tramite \texttt{docker-compose.yml}) per favorire una futura espansione orizzontale, con l'eventuale necessità di load balancer.
...
\begin{itemize}[leftmargin=*]
    \item Uno schema base con un singolo nodo che gestisce i container del frontend, del backend e del database (utile per lo sviluppo e il testing);
...
\begin{itemize}[leftmargin=*]
    ...
    \item da capire se fare un'interfaccia notifiche o no, in generale come gestire le notifiche, essendo un'applicazione web
\end{itemize}
