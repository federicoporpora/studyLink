...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/modello-dei-casi-d-uso.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/modello-del-dominio-utente.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/modello-del-dominio-evento.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/modello-del-dominio-filtro.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/modello-del-dominio-chat.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/modello-del-dominio-log.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/diagramma-dei-package.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/diagramma-dei-package-registrazione-autenticazione.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/diagramma-dei-package-profilo.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/diagramma-dei-package-evento.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/diagramma-dei-package-bacheca.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/diagramma-dei-package-comunicazione.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/interazione-registrazione.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/interazione-autenticazione.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/interazione-elimina-utente.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/interazione-modifica-profilo.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/interazione-creazione-evento.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/interazione-gestione-evento.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/interazione-chat.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/interazione-commento.png}
\end{figure}
...
Per il Client (L1), verrà impiegato un framework web frontend reattivo moderno, capace di creare interfacce dinamiche e responsive.
Per l'implementazione del Server (L2), si utilizzerà un framework web lato server robusto, orientato agli oggetti e ad alte prestazioni (es. ASP.NET Core con C\#).
Per la Persistenza (L3), la scelta ricade su un DBMS relazionale, adatto alla natura strutturata dei dati del dominio, interfacciato tramite la libreria ORM nativa.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/diagramma-dei-package-progettazione.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/diagramma-dei-componenti-progettazione.png}
\end{figure}
...
\subsubsection{Diagramma di dettaglio: Account}

Di seguito è presentato il diagramma delle classi del modello del dominio riguardante l'Account.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/diagramma-di-dettaglio-account.png}
\end{figure}
...
\begin{itemize}[leftmargin=*]
    ...
    \item È stata introdotta la classe astratta Account, la quale incapsula esclusivamente i dati fondamentali di autenticazione (email e passwordHash).
...
\newpage
\subsubsection{Diagramma di dettaglio: Evento}

Di seguito è presentato il diagramma delle classi del modello del dominio riguardante gli Eventi.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/diagramma-di-dettaglio-evento.png}
\end{figure}
...
\begin{itemize}[leftmargin=*]
    ...
    \item La classe astratta Evento implementa IEvento fattorizzando il codice comune, e si specializza in EventoAPostiLimitati (che introduce l'attributo posti) ed EventoAPostiIllimitati.
...
\newpage
\subsubsection{Diagramma di dettaglio: Chat}

Di seguito è presentato il diagramma delle classi del modello del dominio riguardante la Chat.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/diagramma-di-dettaglio-chat.png}
\end{figure}
...
\newpage
\subsubsection{Diagramma di dettaglio: Filtro}

Di seguito è presentato il diagramma delle classi del modello del dominio riguardante i Filtri.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/diagramma-di-dettaglio-filtro.png}
\end{figure}
...
\newpage
\subsubsection{Diagramma di dettaglio: Log}

Di seguito è presentato il diagramma delle classi del modello del dominio riguardante i Log.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/diagramma-di-dettaglio-log.png}
\end{figure}
...
\subsubsection{Interfaccia: Registrazione e Autenticazione}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{images/interfaccia-utente-registrazione.png}
    \hspace{0.05\textwidth}
    \includegraphics[width=0.35\textwidth]{images/interfaccia-utente-autenticazione.png}
    \caption{Registrazione (sinistra) e Autenticazione (destra)}
\end{figure}

\subsubsection{Interfaccia: Profilo ed Evento}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{images/interfaccia-utente-profilo.png}
    \hspace{0.05\textwidth}
    \includegraphics[width=0.35\textwidth]{images/interfaccia-utente-evento.png}
    \caption{Profilo (sinistra) ed Evento (destra)}
\end{figure}

\subsubsection{Interfaccia: Bacheca}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{images/interfaccia-bacheca.png}
\end{figure}

\subsubsection{Interfaccia: Comunicazione}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{images/diagramma-entity-relationship.png}
\end{figure}

È da notare che:
\begin{itemize}[leftmargin=*]
    \item Cosa importantissima da notare.
    \item Cosa un po' meno importante da notare.
\end{itemize}
...
\begin{itemize}[leftmargin=*]
    ...
    \item aggiungere in tutto il documento il fatto che nel filtro calcoliamo la distanza dall'indirizzo
    \item da capire se la notifica va nell'analisi del modello del dominio, in particolare se è una classe oppure no, dato che abbiamo fatto la tabella delle informazioni ma non abbiamo fatto nessuno schema
    \item in modello del dominio tipodiluogo deve essere un enum e non {pubblico, privato}
    \item in interazioni in particolare modifica evento, da aggiungere anche elimina evento, ma da non fare il grafico, dire solo che è praticamente uguale a modifica evento solo che elimina la classe invece di modificarla
    \item pensare a se mettere l'amministratore, poi nel prototipo non si scrive
    \item da togliere la materia all'interno dell'evento nel modello del dominio
    \item tra luogo e evento è 1 - 1? ci sono in teoria luoghi che possono avere più eventi e i luoghi esistono a prescindere degli eventi, ma a lato codice non ha senso dire che esistono, dato che vivono esclusivamente dentro la classe Evento
\end{itemize}
