...
\begin{tabularx}{\textwidth}{|p{1.2cm}|X|p{2.6cm}|}
    ...
    \endhead
        ...
        \reqlabel{R05N}R05N & Il formato di data e orario è GG/MM/AAAA e HH:MM 24h & Non funzionale \\ \hline
        ...
        \reqlabel{R10N}R10N & L'applicazione deve poter operare in totale autonomia senza l'intervento attivo di amministratori umani, garantendo così una maggiore tutela della privacy degli utenti & Non funzionale \\ \hline
\end{tabularx}
    ...
    \textbf{Scenari alternativi} & 
        \begin{itemize}[nosep, leftmargin=*, before={\vspace{-0.5\baselineskip}}, after={\vspace{-0.8\baselineskip}}]
            ...
            \begin{enumerate}[nosep, leftmargin=*]
                \setcounter{enumi}{3}
                \item Il sistema informa l'Utente che l'Email è già registrata
            ...
            \end{enumerate}
            \item L'Email non è istituzionale
            \begin{enumerate}[nosep, leftmargin=*]
                \setcounter{enumi}{3}
                \item Viene mostrato un messaggio di errore
...
\begin{tabularx}{\textwidth}{|X|X|X|X|}
    ...
    \endhead
    Furto Credenziali Utente & \textbf{Media.} La Mail istituzionale è nota, le password devono essere indovinate & Imposizione di requisiti di sicurezza sulle Password e limitazioni di tentativi di accesso
...
\begin{tabularx}{\textwidth}{|p{5.5cm}|X|}
    ...
    Registrazione vincolata & \begin{itemize}[nosep, leftmargin=*, before={\vspace{-0.5\baselineskip}}, after={\vspace{-0.8\baselineskip}}]
                ...
                \end{itemize} \\ \hline
    Sistema di Chat integrato & \begin{itemize}[nosep, leftmargin=*, before={\vspace{-0.5\baselineskip}}, after={\vspace{-0.8\baselineskip}}]
    ...
    Cifratura delle Comunicazioni & 
                La sicurezza dipende dal tipo di cifratura:
                \begin{enumerate}[nosep, leftmargin=*, before={\vspace{-0.5\baselineskip}}, after={\vspace{-0.8\baselineskip}}]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,keepaspectratio]{images/security-use-misuse.png}
    \caption{Diagramma dei Security use case e misuse case}
\end{figure}
...
\begin{tabularx}{\textwidth}{|p{1.2cm}|X|p{2.6cm}|}
    ...
    \reqlabel{R11N}R11N & La comunicazione tra client e server deve essere obbligatoriamente cifrata tramite protocollo HTTPS/TLS. & Non funzionale \\ \hline
    \reqlabel{R12N}R12N & Dopo 5 tentativi di Autenticazione falliti consecutivi, il sistema blocca l'accesso a quell'account per 15 minuti. & Non funzionale \\ \hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|p{3.8cm}|X|}
    ...
    \textbf{Scenari alternativi} & 
        \begin{itemize}[nosep, leftmargin=*, before={\vspace{-0.5\baselineskip}}, after={\vspace{-0.8\baselineskip}}]
            ...
            \end{enumerate}
        \end{itemize} \\ \hline
    \textbf{Requisiti non funzionali} & \hyperref[R02N]{R02N}, \hyperref[R11N]{R11N}, \hyperref[R12N]{R12N} \\ \hline
    \textbf{Punti aperti} & \\ \hline
\end{tabularx}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.5\textheight,keepaspectratio]{images/modello-dei-casi-d-uso.png}
    \caption{Modello dei casi d'uso aggiornato}
\end{figure}
%
...
\begin{tabularx}{\textwidth}{|p{3.2cm}|X|p{2.3cm}|p{2.8cm}|}
    ...
    Autenticazione & \begin{itemize}[nosep, leftmargin=*, before={\vspace{-0.5\baselineskip}}, after={\vspace{-0.8\baselineskip}}]
                        \item Gestione dati;
                        \item Interazione esterno;
                    \end{itemize} & Semplice & \hyperref[R03F]{R03F}, \hyperref[R12N]{R12N} \\ \hline
...
\begin{tabularx}{\textwidth}{|p{2.8cm}|p{1.8cm}|p{3.2cm}|X|}
    ...
    Testo & semplice & Protezione media & Non più di 500 caratteri \\ \hline
...
\begin{tabularx}{\textwidth}{|p{3.0cm}|p{2.2cm}|p{3.5cm}|X|}
    ...
    Creazione e sicurezza dell'account [R02N, R08N, R12N] & Sicurezza & Migliora l'integrità dei dati e previene accessi non autorizzati obbligando all'uso di credenziali sicure e univoche & Registrazione, Autenticazione, Gestione profilo \\ \hline
...
\begin{tabularx}{\textwidth}{|p{4.5cm}|X|p{4cm}|}
    ...
    View Gestione Evento & Dati Evento precompilati, Elenco Partecipanti (con opzione di rimozione) & Gestione evento, Rimozione partecipante, Cancellazione evento, Modifica evento \\ \hline
...
Il programma non fa utilizzo di nessun sistema esterno nel suo funzionamento interno, l'unico sistema esterno presente è il visualizzatore di log che interagisce attraverso un file generato dall'applicazione per fornire servizi di sicurezza.
...
\begin{tabularx}{\textwidth}{|X|X|X|}
    ...
    Dominio & Team Progettazione & Team Back-end, Team Database, Team Sicurezza \\ \hline
\end{tabularx}
\vspace{0.5cm}
\begin{tabularx}{\textwidth}{|X|X|}
    \hline
...
Il committente ha richiesto di aggiungere la possibilità di penalizzare gli Utenti a seguito di disiscrizioni a ridosso di Eventi a cui si è iscritti o che si sono organizzati, oppure per comportamenti scorretti.
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \fcolorbox{linkColor}{white}{\includegraphics[width=0.98\linewidth,height=0.30\textheight,keepaspectratio]{images/login.jpg}}
        \caption{Schermata di Accesso}
    \end{minipage}\hfill
    \begin{minipage}{0.45\textwidth}
        \centering
        \fcolorbox{linkColor}{white}{\includegraphics[width=0.98\linewidth,height=0.30\textheight,keepaspectratio]{images/registrazione.jpg}}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.31\textwidth}
        \centering
        \fcolorbox{linkColor}{white}{\includegraphics[width=0.98\linewidth,height=0.30\textheight,keepaspectratio]{images/bacheca.jpg}}
        \caption{Bacheca - Esplora}
    \end{minipage}\hfill
    \begin{minipage}{0.31\textwidth}
        \centering
        \fcolorbox{linkColor}{white}{\includegraphics[width=0.98\linewidth,height=0.30\textheight,keepaspectratio]{images/miei-eventi.jpg}}
        \caption{Bacheca - I Miei Eventi}
    \end{minipage}\hfill
    \begin{minipage}{0.31\textwidth}
        \centering
        \fcolorbox{linkColor}{white}{\includegraphics[width=0.98\linewidth,height=0.30\textheight,keepaspectratio]{images/passati.jpg}}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \fcolorbox{linkColor}{white}{\includegraphics[width=0.98\linewidth,height=0.30\textheight,keepaspectratio]{images/crea-evento.jpg}}
        \caption{Creazione Evento}
    \end{minipage}\hfill
    \begin{minipage}{0.45\textwidth}
        \centering
        \fcolorbox{linkColor}{white}{\includegraphics[width=0.98\linewidth,height=0.30\textheight,keepaspectratio]{images/modifica-evento.jpg}}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \fcolorbox{linkColor}{white}{\includegraphics[width=0.98\linewidth,height=0.30\textheight,keepaspectratio]{images/evento-passato.jpg}}
        \caption{Dettagli Evento Passato}
    \end{minipage}\hfill
    \begin{minipage}{0.45\textwidth}
        \centering
        \fcolorbox{linkColor}{white}{\includegraphics[width=0.98\linewidth,height=0.30\textheight,keepaspectratio]{images/chat.jpg}}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \fcolorbox{linkColor}{white}{\includegraphics[width=0.98\linewidth,height=0.30\textheight,keepaspectratio]{images/mio-profilo.jpg}}
        \caption{Profilo Personale}
    \end{minipage}\hfill
    \begin{minipage}{0.45\textwidth}
        \centering
        \fcolorbox{linkColor}{white}{\includegraphics[width=0.98\linewidth,height=0.30\textheight,keepaspectratio]{images/modifica-profilo.jpg}}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \fcolorbox{linkColor}{white}{\includegraphics[width=0.98\linewidth,height=0.30\textheight,keepaspectratio]{images/profilo.jpg}}
        \caption{Profilo Pubblico Utente}
    \end{minipage}\hfill
    \begin{minipage}{0.45\textwidth}
        \centering
        \fcolorbox{linkColor}{white}{\includegraphics[width=0.98\linewidth,height=0.30\textheight,keepaspectratio]{images/commento.jpg}}
