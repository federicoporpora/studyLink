...
Il metodo di analisi \texttt{modificaProfilo()} è stato suddiviso in \texttt{modificaDati()} e \texttt{modificaPassword()} nel \texttt{ControllerProfilo} per poter applicare controlli differenti a seconda del valore del dato modificato.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.5\textheight,keepaspectratio]{images/interazione2-autenticazione.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.5\textheight,keepaspectratio]{images/interazione2-modificaDati.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.5\textheight,keepaspectratio]{images/interazione2-modificaPassword.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.5\textheight,keepaspectratio]{images/interazione2-eliminaAccount.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.5\textheight,keepaspectratio]{images/interazione2-creazioneEvento.png}
    \caption{Diagramma di sequenza: Gestione evento - Creazione}
\end{figure}
%
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.5\textheight,keepaspectratio]{images/interazione2-gestioneEvento.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.5\textheight,keepaspectratio]{images/interazione2-filtroEventi.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.5\textheight,keepaspectratio]{images/interazione2-chat.png}
    \caption{Diagramma di sequenza: Comunicazione - Chat}
\end{figure}
%
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.5\textheight,keepaspectratio]{images/interazione2-commento.png}
