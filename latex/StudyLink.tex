...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{images/interfacciautente-registrazione.png}
    \hspace{0.05\textwidth}
    \includegraphics[width=0.35\textwidth]{images/interfacciautente-autenticazione.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{images/interfacciautente-profilo.png}
    \hspace{0.05\textwidth}
    \includegraphics[width=0.35\textwidth]{images/interfacciautente-evento.png}
